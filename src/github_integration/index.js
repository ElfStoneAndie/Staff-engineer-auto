 ...
 * @param {string} owner - Repository owner
 * @param {string} repo - Repository name
 * @param {string} [state='open'] - PR state filter ('open', 'closed', 'all')
 * @returns {Promise<Array>} Array of pull request objects
 */
export async function listPullRequests(octokit, owner, repo, state = 'open') {
 ...
 * @param {string} [mergeMethod='merge'] - Merge method ('merge', 'squash', 'rebase')
